...
/*************************************************************************
 * Copyright (C) 1995-2000, 2022, 2023, Rene Brun and Fons Rademakers.               *
 * All rights reserved.                                                  *
 *                                                                       *
...
public:
   ...
   virtual Int_t FindBin(Double_t x, Double_t y, Double_t z = 0) override;
   virtual Int_t FindFixBin(Double_t x, Double_t y, Double_t z = 0) const override;
